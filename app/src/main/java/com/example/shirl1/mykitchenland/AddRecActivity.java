...
/*
    ...
    //HOW TO ADD ALL ROWS EACH PRESS TO TABLE
    public void btn_add_ingre_on_click(View v){

        EditText e_in = new EditText(this);
        EditText e_am = new EditText(this);

        String in1 = e_in.getText().toString();
        String in2 = e_am.getText().toString();
